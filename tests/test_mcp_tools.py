...
class TestToolMetadata:
    ...
    def test_all_phase_a_tools_are_read_only(self):
        ...
        for name in phase_a_tools:
            assert metadata[name]["permission"] == ToolPermission.READ, f"{name} should be READ permission"
    ...
    def test_tool_metadata_has_required_fields(self):
        ...
        for name, meta in metadata.items():
            ...
            assert meta["parameters"].get("type") == "object", f"{name} parameters should be object type"
...
class TestListLocations:
    ...
    @pytest.mark.asyncio
    async def test_returns_locations_on_success(self, tools: HomeboxMCPTools, mock_client: MagicMock):
    ...
    @pytest.mark.asyncio
    async def test_passes_filter_children_parameter(self, tools: HomeboxMCPTools, mock_client: MagicMock):
...
class TestGetLocation:
    ...
    @pytest.mark.asyncio
    async def test_returns_location_on_success(self, tools: HomeboxMCPTools, mock_client: MagicMock):
    ...
    @pytest.mark.asyncio
    async def test_returns_error_for_missing_location(self, tools: HomeboxMCPTools, mock_client: MagicMock):
...
class TestListItems:
    ...
    async def test_returns_items_on_success(self, tools: HomeboxMCPTools, mock_client: MagicMock):
        ...
        mock_client.list_items.assert_called_once_with("test-token", location_id=None)
    ...
    async def test_filters_by_location(self, tools: HomeboxMCPTools, mock_client: MagicMock):
        ...
        mock_client.list_items.assert_called_once_with("test-token", location_id="loc1")
...
class TestGetItem:
    ...
    @pytest.mark.asyncio
    async def test_returns_error_for_missing_item(self, tools: HomeboxMCPTools, mock_client: MagicMock):
